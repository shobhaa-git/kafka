...
class RemoteLogManagerTest {
  ...
  def testDeleteLogSegmentDueToRetentionTimeBreach(segmentCount: Int, deletableSegmentCount: Int): Unit = {
    ...
    val remoteLogSizeMetricValue = brokerTopicStats.topicAggregatedStats(topicIdPartition.topicPartition().topic()).remoteLogSize()
    val remoteLogMetadataCountMetricValue = brokerTopicStats.topicAggregatedStats(topicIdPartition.topicPartition().topic()).remoteLogMetadataCount()
  ...
  def updateTotalTierLagAfterSegmentUpload(): Unit = {
    ...
    val offsetLag = brokerTopicStats.topicAggregatedStats(topicIdPartition.topicPartition().topic()).offsetLag()
    val bytesLag = brokerTopicStats.topicAggregatedStats(topicIdPartition.topicPartition().topic()).bytesLag()
